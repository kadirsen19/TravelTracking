    ...
    <div class="span12">
      <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          <form action="insertTravel" method="post" class="form-horizontal">
            <div class="control-group">
              <label class="control-label">Seyehat Yeri :</label>
              <div class="controls">
                <input type="text"  name="place" class="span11" placeholder="Seyehat Yeri" />
              </div>
            </div>
			...
			<div class="control-group">
              ...
              <div class="controls">
                <textarea class="span11" name="reason" placeholder="Amaç" ></textarea>
              </div>
            </div>
			<div class="control-group">
				<label class="control-label">Gidiş Tarihi</label>
					  <div class="controls">
						<div  data-date="12-02-2012" class="input-append date datepicker">
						  <input type="text" name="departureDate" data-date-format="mm-dd-yyyy" class="span11" >
							  <span class="add-on">
								  <i class="icon-th">
								  </i>
							  </span> 
			...
			<div class="control-group">
				<label class="control-label">Dönüş Tarihi</label>
					  <div class="controls">
						<div  data-date="12-02-2012" class="input-append date datepicker">
						  <input type="text" name="returnDate"  data-date-format="mm-dd-yyyy" class="span11" >
							  <span class="add-on">
								  <i class="icon-th">
								  </i>
							  </span> 
